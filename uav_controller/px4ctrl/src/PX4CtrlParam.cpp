...
void Parameter_t::config_from_ros_handle(const ros::NodeHandle &nh)
{
	...
	read_essential_param(nh, "gain/Kvilim", gain.Kvilim);
	...
	read_essential_param(nh, "use_onboard_landing", use_onboard_landing);
	read_essential_param(nh, "use_onboard_takeoff", use_onboard_takeoff);
