...
public:
  ...
  // for rc takeoff_land
  double takeoff_land_cmd;
  double last_takeoff_land_cmd;
  double have_init_last_takeoff_land_cmd{false};
  bool toggle_land;
  bool toggle_takeoff;
  bool exit_takeoff;
  bool exit_land;
  static constexpr double TAKEOFF_SHIFT_VALUE = 0.25;
  static constexpr double LAND_SHIFT_VALUE = 0.75;
