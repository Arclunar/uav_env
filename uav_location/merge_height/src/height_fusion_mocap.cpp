...
void odom_mocap_cb(const geometry_msgs::PoseStampedConstPtr& msg){

    geometry_msgs::PoseStamped pose_fusion = *msg;
   
    pose_fusion.pose.position.z = current_height;
